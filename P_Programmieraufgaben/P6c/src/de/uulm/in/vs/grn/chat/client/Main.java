 ...
 * GRNCP Chat Client
 *
 * Type "//users" to display user list in chat.
 * Logout beim schließen des Chat Fensters.
 * Fehler werden als entsprechende Exceptions auf stderr ausgegeben.
 */
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Verbose console output for debugging purposes
        //Debug.enable();
